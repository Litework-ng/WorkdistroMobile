    ...
    return(
        <ScrollView style={{backgroundColor:'#fff'}}>
             ...
             <View>
                    ...
                    <View style={{flexDirection:'row', paddingHorizontal:20, gap:22, marginBottom:8,  }}>
                        <View style={{flexDirection:'row', gap:3, justifyContent:'center'}}>
                            <Text style={{fontSize:12, fontWeight:'400', color:'#8B8B8B'}}>In</Text>
                            <Text style={{fontSize:14, fontWeight:'500', }}>N20,000.00</Text>
                        </View>
                        <View style={{flexDirection:'row', gap:3}}>
                             <Text style={{fontSize:12, fontWeight:'400',  color:'#8B8B8B'}}>Out</Text>
