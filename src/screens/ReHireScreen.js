...
const ReHire = ({ navigation }) => {
    const [subject, setSubject] = useState('');
    const [text, SetText] = useState('');
    const maxLength = 500;
    const [distro, setDistroworker] = useState('Tosin Alabi')
    ...
    return(
      ...
      <Text style={styles.headerText}>Re-Hire Worker</Text>
      </View>
      ...
      <View>
        <Text>Distroworker</Text>
        <TextInput
        style={styles.distroworkerInput}
        value={distro}
