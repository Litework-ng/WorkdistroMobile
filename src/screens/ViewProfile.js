  ...
  return (
    <ScrollView style={{ backgroundColor: "#fff" }}>
      ...
      <View style={{ flexDirection: "row", paddingLeft: 20 }}>
        ...
        <View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            />
            <Text
              style={{ fontSize: 14, fontWeight: "400", marginBottom: 2.5 }}
            >
              4.7(20 Reviews)
            </Text>
          </View>
      ...
      <View style={{ padding: 20 }}>
        <Text style={{ fontSize: 16, fontWeight: "600", marginTop: 32 }}>
          About Worker
        </Text>
        <Text
          style={{
        ...
        >
          ...
          hendrerit placerat erat aliquet scelerisque. Sed malesuada ornare
          eros, vitae faucibus odio sollicitudin eu.
        </Text>
        <Text style={{ fontSize: 16, fontWeight: "600", marginTop: 32 }}>
          Reviews
        </Text>
      ...
      <TouchableOpacity style={{ alignSelf: "center", marginBottom: 32 }}>
        <Text style={{ fontSize: 16, fontWeight: "400", color: "#31DE9E" }}>
          View All...
        </Text>
      </TouchableOpacity>
      <TouchableOpacity
