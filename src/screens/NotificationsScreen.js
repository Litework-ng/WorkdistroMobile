...
const NotificationScreen = () => {
    return(
        <ScrollView style={{backgroundColor:'white', padding:20,}}> 
                <Text style={{fontSize:16, fontWeight:'600', alignSelf:'center', marginTop:20,}}>Notifications</Text>
                <Text style={{fontSize:16, fontWeight:'500', marginVertical:16,}}>Today</Text>
