...
import { View, Text, FlatList, TouchableOpacity, StyleSheet, TextInput, Alert, ScrollView, ActivityIndicator, Modal } from 'react-native';
      ...
      >
        <View style={styles.modalBackground}>
          <View style={styles.activityIndicatorWrapper}>
            <ActivityIndicator animating={loading} size="large" color='#1F2A47'/>
