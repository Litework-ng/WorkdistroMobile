...
const LoginNavigator = ({userSelection}) => {
  ...
  return (
      ...
      <Stack.Navigator>
        {userRole === 'findWorker' ? (
          <Stack.Screen name="ClientLogin" component={LoginScreen} options={{ headerShown: false }} />
        ) : (
          <Stack.Screen name="WorkerLogin" component={LoginWorkerScreen} options={{ headerShown: false }} />
        )}
      </Stack.Navigator>
