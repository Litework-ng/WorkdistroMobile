...
const Bids = ({navigation}) => {
    ...
    return(
        <View style={{borderWidth:1, padding:20,backgroundColor:'#fff', borderColor:'#D0D0D0', marginBottom:20,}}>
            <View  style={{flexDirection:'row', }} >
                <Image source={require('../../assets/images/profilepic2.png')} style={{width:50, height:50, marginRight:10,}}/>
                 <View>
                    <View style={{flexDirection:'row', gap:140,}}>
                        ...
                        <Text style={{fontSize:10, fontWeight:400, color:'#636363'}}>3 mins ago</Text>
                ...
                />
                     ...
                     <Text style={{fontSize:14, fontWeight:'600',alignSelf:'flex-start' }}>Bid:N5000</Text>
                    ...
                    <Text style ={{fontSize:14, fontWeight:600, marginTop:20,}}>Cover Letter</Text>
                    <Text  style ={{fontSize:12, fontWeight:400,color:'#3F3F3F', marginTop:10, width:335,}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas iaculis molestie nisi vitae tincidunt. Nulla at ante mauris. Cras hendrerit placerat erat aliquet scelerisque. Sed malesuada ornare eros, vitae faucibus odio sollicitudin eu.</Text>
                  <View style={{flexDirection:'row', gap:32, alignSelf:'center', marginTop:27,}}>
                    <TouchableOpacity  style={styles.viewProfileButton}  onPress={()=>navigation.navigate('ViewProfile')}>
                        <Text style={styles.viewProfileButtonText}>View Profile</Text>
                    </TouchableOpacity>
                    <TouchableOpacity  style={styles.hireButton} onPress={()=>navigation.navigate('Hire')}>
